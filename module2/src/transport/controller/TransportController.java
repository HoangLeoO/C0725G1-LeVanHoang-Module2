...
public class TransportController {
    ...
    private static void showDeleteMenu() {
        ...
        if (transport instanceof Car) {
            ...
            System.out.println(" Xóa phương tiện với biển số xe : " + plate + " thành công");
    ...
    private static void showEditMenu() {
        ...
        Transport transport = transportService.findByLicensePlate(TransportView.editTransport());
        if (transport instanceof Car) {
            CarController.carService.editCar(CarView.editCar((Car) transport));
            System.out.println(" Chỉnh sửa phương tiện với biển số xe : " + plate + " thành công");
        } else if (transport instanceof Motorbike) {

...
public class MotorbikeView {
    ...
    public static void showAllMotorbike(List<Motorbike> motorbikes) {
        ...
        for (Motorbike motorbike : motorbikes) {
            if (motorbike != null) {
                System.out.printf("| %-10s | %-15s | %-6d | %-15s | %-10s |%n",
                        motorbike.getLicensePlate(),
                        motorbike.getManufacturer(),
                        motorbike.getYearOfManufacture(),
                        motorbike.getOwner(),
                        motorbike.getEnginePower());
                found = true;
            }
        }

        if (!found) {
            System.out.println("|                 Không có dữ liệu xe máy                    |");
        }
